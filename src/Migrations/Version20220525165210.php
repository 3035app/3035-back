...
class Version20220525165210 extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pia ADD requested_hiss_opinion_text TEXT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pia DROP requested_hiss_opinion_text');
